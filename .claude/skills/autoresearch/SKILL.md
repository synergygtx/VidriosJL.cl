...
Usuario dice: "Optimiza el skill de impeccable"

1. Leo `impeccable/SKILL.md` completo
2. Propongo 4 criterios binarios (basado en el tipo de output del skill)
3. El usuario confirma o ajusta
4. Creo branch `autoresearch/impeccable`
