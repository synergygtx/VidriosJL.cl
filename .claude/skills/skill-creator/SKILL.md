---
name: skill-creator
description: Guide for creating custom skills in Forge. Use when you need to create a new skill to extend Claude's capabilities with specialized knowledge, workflows, or tools.
license: MIT
---

# Skill Creator - Forge Edition

This skill provides guidance for creating custom skills following Forge standards.
...
**Create skills following Forge standards for consistency and quality.**
